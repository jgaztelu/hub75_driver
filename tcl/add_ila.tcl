...
set_property C_ADV_TRIGGER  false  [get_debug_cores ila1]
set_property ALL_PROBE_SAME_MU_CNT 4  [get_debug_cores ila1]

set ila_nets [get_nets -hier -filter {MARK_DEBUG=="true"}]
set num_ila_nets [llength [get_nets [list $ila_nets]]]

set_property port_width 1 [get_debug_ports ila1/clk]
foreach net $ila_nets {
	create_debug_port ila1 dbg_$net
	connect_debug_port ila1/dbg_$net [get_nets net]
	}
